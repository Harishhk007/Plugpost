...
class Usersform(forms.ModelForm):
    ...
    User_Gender = forms.ChoiceField(choices=GENDER_CHOICES, widget=forms.Select(attrs={'class': 'form-control','style':'border:3px solid white;margin:40px;width:300px;height:100%;background-color:transparent;font-size:20px;border-radius:20px;outline:0;color:white;font-family:"poppins";',}))
